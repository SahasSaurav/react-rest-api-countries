  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="flex flex-col justify-center items-center  w-full text-white ">
        <svg className="h-64 w-full sm:w-auto"
          version="1.1"
          ...
          space="preserve"
        >
          <ellipse cx="540.6" cy="549.3" rx="527.5" ry="34.9" fill="#f2f2f2" />
          <path
            className="st1"
            fill="#B8BDC4"
          ...
          <circle className="st4" fill="#ff9563" cx="582.9" cy="355.1" r="5" />
          <circle className="st4" fill="#ff9563" cx="460.9" cy="355.1" r="5" />
        </svg>

        {/* <h2 className="text-white text-6xl font-medium">Error 404</h2> */}
        <h3 className="text-4xl">Page Not Found</h3>
        <p className="text-gray-200 opacity-75  text-xl text font-normal">
